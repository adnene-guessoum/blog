...
const home = () => (
	<div className="container">
		<div className="jumbotron mt-5">
			...
			<p className="lead">Je m&apos;appelle Adnene et j&apos;écris toutes sortes de choses à propos de mon parcours de développeur et de mes opinions en général</p>
...
<div className="description-project">
				...
				<p className="lead">
					<a className="btn btn-primary btn-lg" href="https://owling-dev.vercel.app/" 
